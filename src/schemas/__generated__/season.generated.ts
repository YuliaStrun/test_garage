...
export type SeasonQuery = { __typename?: 'Query' } & {
  seasonBySlugEntity?: Types.Maybe<
        ...
        { __typename?: 'SeasonEntity' } & Pick<Types.SeasonEntity, 'id'> & {
            attributes?: Types.Maybe<
              { __typename?: 'Season' } & Pick<
                Types.Season,
                'slug' | 'title' | 'numberTitle' | 'previewLead' | 'metaTitle' | 'metaDescription'
              > & {
                  content?: Types.Maybe<
                    Array<
                      Types.Maybe<
                        ...
                        { __typename?: 'EpisodeEntity' } & Pick<Types.EpisodeEntity, 'id'> & {
                            attributes?: Types.Maybe<
                              { __typename?: 'Episode' } & Pick<
                                Types.Episode,
                                'slug' | 'title' | 'audioDuration' | 'forAdults'
                              > & {
